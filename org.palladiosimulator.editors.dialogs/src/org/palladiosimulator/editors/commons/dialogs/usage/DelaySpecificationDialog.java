...
public class DelaySpecificationDialog extends OpenStoExDialog {
     ...
     * @see org.palladiosimulator.editors.commons.dialogs.usage.OpenStoExDialog#getRandomVariable(org.eclipse.emf.ecore.EObject)
     */
    @Override
     ...
     * @see org.palladiosimulator.editors.commons.dialogs.usage.OpenStoExDialog#getExpectedType(de.uka.ipd.sdq.stoex.RandomVariable)
     */
    @Override
