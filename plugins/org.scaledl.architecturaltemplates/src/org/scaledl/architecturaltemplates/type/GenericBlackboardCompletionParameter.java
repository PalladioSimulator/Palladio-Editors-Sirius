 ...
 *
 * <!-- begin-model-doc -->
 * The input of a completion stems from the MDSD blackboard and is an arbitray model, characterized by the given file extension. The user can freely specify this extension as String.
 * <!-- end-model-doc -->
 *
 * <p>
 ...
 * </p>
 * <ul>
 *   <li>{@link org.scaledl.architecturaltemplates.type.GenericBlackboardCompletionParameter#getFileExtension <em>File Extension</em>}</li>
 * </ul>
 *
...
public interface GenericBlackboardCompletionParameter extends CompletionParameter {
    ...
    /**
     * Sets the value of the '{@link org.scaledl.architecturaltemplates.type.GenericBlackboardCompletionParameter#getFileExtension <em>File Extension</em>}' attribute.
