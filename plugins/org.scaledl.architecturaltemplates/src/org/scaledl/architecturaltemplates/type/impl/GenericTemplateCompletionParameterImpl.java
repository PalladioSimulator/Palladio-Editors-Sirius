...
GenericTemplateCompletionParameter {
    ...
    protected EClass eStaticClass() {
        return TypePackage.Literals.GENERIC_TEMPLATE_COMPLETION_PARAMETER;
    }
    ...
    public void setTemplateFileURI(final String newTemplateFileURI) {
        ...
        if (this.eNotificationRequired()) {
            this.eNotify(new ENotificationImpl(this, Notification.SET,
                    TypePackage.GENERIC_TEMPLATE_COMPLETION_PARAMETER__TEMPLATE_FILE_URI, oldTemplateFileURI,
    ...
    public int eDerivedStructuralFeatureID(final int baseFeatureID, final Class<?> baseClass) {
        if (baseClass == TemplateProvidingEntity.class) {
            ...
            case TypePackage.TEMPLATE_PROVIDING_ENTITY__TEMPLATE_FILE_URI:
                return TypePackage.GENERIC_TEMPLATE_COMPLETION_PARAMETER__TEMPLATE_FILE_URI;
            default:
                return -1;
            }
        }
...
} // GenericTemplateCompletionParameterImpl
