...
/**
 * This is the action bar contributor for the Type model editor. <!-- begin-user-doc --> <!--
 * end-user-doc -->
 * 
 * @generated
 */
public class TypeActionBarContributor extends EditingDomainActionBarContributor implements ISelectionChangedListener {
    ...
    protected IAction showPropertiesViewAction = new Action(
        ...
        public void run() {
            try {
                TypeActionBarContributor.this.getPage().showView("org.eclipse.ui.views.PropertySheet");
    ...
    protected IAction refreshViewerAction = new Action(
        ...
        @Override
        public void run() {
            if (TypeActionBarContributor.this.activeEditorPart instanceof IViewerProvider) {
                final Viewer viewer = ((IViewerProvider) TypeActionBarContributor.this.activeEditorPart).getViewer();
                if (viewer != null) {
                    viewer.refresh();
                }
            }
    ...
    public void contributeToMenu(final IMenuManager menuManager) {
        ...
        final IMenuManager submenuManager = new MenuManager(
                ArchitecturaltemplatesEditorPlugin.INSTANCE.getString("_UI_TypeEditor_menu"),
                "org.scaledl.architecturaltemplates.typeMenuID");
        ...
        this.createChildMenuManager = new MenuManager(
                ArchitecturaltemplatesEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
        submenuManager.insertBefore("additions", this.createChildMenuManager);

        // Prepare for CreateSibling item addition or removal.
        //
        this.createSiblingMenuManager = new MenuManager(
                ArchitecturaltemplatesEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
